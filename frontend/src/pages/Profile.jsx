...
const Profile = () => {
  ...
  const getRoleColor = (role) => {
    ...
    return role.toLowerCase() === 'admin' ? 'bg-gradient-to-r from-purple-500 to-indigo-600' : 'bg-gradient-to-r from-red-500 to-pink-500';
  };
  ...
  if (error)
    return (
      <div className="container mx-auto px-4 py-8 text-center bg-gradient-to-br from-red-100 via-pink-100 to-purple-100 min-h-screen">
        <div className="bg-white border-l-4 border-red-500 text-red-700 p-4 rounded-lg shadow-xl max-w-md mx-auto" role="alert">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white shadow-2xl rounded-3xl overflow-hidden">
          <div className="md:flex">
            <div className={`md:w-1/3 ${getRoleColor(user.role)} p-8 text-white relative`}>
              ...
              <div className="text-center mb-8">
                <div className="relative inline-block">
                  <img
                    src="https://images.unsplash.com/photo-1722286419682-03c1aad69d5a?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="Avatar"
                    className="w-48 h-48 rounded-full border-4 border-white object-cover shadow-lg"
                  />
                  <label htmlFor="avatar-upload" className="absolute bottom-0 right-0 bg-white rounded-full p-2 cursor-pointer shadow-md hover:shadow-lg transition-all duration-300">
            ...
            <div className="md:w-2/3 p-8">
              <h2 className="text-3xl font-semibold mb-6 text-gray-800 border-b pb-2">Informazioni Personali</h2>
              ...
              <div className="mb-8">
                <h3 className="text-2xl font-semibold mb-4 text-gray-800">Preferenze</h3>
                <div className="flex items-center">
                  ...
                  <button
                    ...
                    className={`text-white py-2 px-6 rounded-full ${
                      user.subscribedToBlog ? "bg-green-500 hover:bg-green-600" : "bg-red-500 hover:bg-red-600"
              ...
              {user.role.toLowerCase() === 'admin' && (
                <div className="mb-8">
                  <h3 className="text-2xl font-semibold mb-4 text-gray-800">Azioni Amministratore</h3>
